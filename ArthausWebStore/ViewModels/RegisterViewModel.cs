...
namespace ArthausWebStore.ViewModels
{
    ...
    {
        [Display(Name = "User Name"), StringLength(60, MinimumLength = 5)]
        ...
        ErrorMessage = "Incorrect/incomplete format of password.")]
        ...
        [Display(Name = "Sign-up to receive our newsletter")]
